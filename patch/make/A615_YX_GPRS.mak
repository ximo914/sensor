...
# Generated at 2014-05-06 09:09:39
# ------------------------------ ARM
...
# ------------------------------ HW and Project
BOARD_VER = CENON61D_3232_11C_BB
  # Description:
...
MOTION_SENSOR_SUPPORT = MT62X0_MC3XXX_I2C
  # Description:
...
CMMB_CAS_2GPP_VER = NONE
  ...
  # Option Values:
  #   NONE: Disable this feature
  #   V10: Support 2G CMMB Post paid version 1.0 (Support,need 2G CMMB Chip Support,Such as IF206)
  # Switch-ability:
  #   Non-switchable
...
SWITCHABLE_FEATURE = 	KAL_TRACE_OUTPUT #FULL,NONE
...
LCD_MODULE = CENON61D_3232_11C_LCM
...
#===============================	CENON Drv start	========================================
CENON_DEBUG_SUPPORT = TRUE		# Johnson_Qian 2015-01-29 add ---- it must always be FALSE for diable debug info 
CENON_SOCKET_SUPPORT = TRUE			# Johnson_Qian 2015-01-29 add
CENON_SOCKET_YX_SUPPORT = TRUE		# Johnson_Qian 2015-01-29 add
CENON_SOCKET_QIWO_SUPPORT = TRUE
#===============================	CENON Drv end  	========================================

###############CENON Custom start###################
CENON_A615_YX_PROJECT = TRUE
CENON_A615_YX_FM_TEST = TRUE
CENON_YX_FOREIGN_VERSION = TRUE
###############CENON Custom end###################
...
COM_DEFS_FOR_CENON61D_3232_11C_LCM = COLOR_LCD CENON61D_3232_11C_LCM TFT_MAINLCD
# *************************************************************************
# Include MODEM.mak
# *************************************************************************
...
CUSTOM_OPTION     +=  __A611__
CUSTOM_OPTION     +=  __A611_VOTO__
CUSTOM_OPTION     += PROJ_A615_YX
REMOVE_CUSTOM_OPTION += __IP_NUMBER__

# *************************************************************************
# Cenon MMI Macro start
# *************************************************************************
CENON_MMI_COMMON_BUG = TRUE

CENON_MMI_MODULE = TRUE
CENON_MMI_SIMPLETTS_FEATRUE  = FALSE
CENON_MMI_LOCALFUNC_FEATRUE = TRUE
CENON_COMMON_FEATURE = TRUE
XI_SUPPORT = TRUE
# *************************************************************************
# Cenon MMI Macro end
# *************************************************************************
