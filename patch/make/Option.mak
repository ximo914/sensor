...
ifdef FONT_ENGINE
  ifneq ($(strip $(FONT_ENGINE)),NONE)
    ...
    ifeq ($(filter $(call Upper,$(strip $(MAIN_LCD_SIZE))),176X220 240X320 320X240 240X400 320X480 360X640 480X800),)
      $(warning ERROR: FONT_ENGINE only supports 176X220, 240X320, 320X240, 240X400, 320X480 360X640 480X800 MAIN_LCD_SIZE)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
#added by ellery for cenon module
CUS_REL_SRC_COMP += cenonmmi
...
ifeq ($(strip $(CENON_CTA_SUPPORT)),TRUE)
    COM_DEFS += __CENON_CTA_SUPPORT__
endif

ifeq ($(strip $(CENON_DEBUG_SUPPORT)),TRUE)
    COM_DEFS += __CENON_DEBUG_SUPPORT__				# Johnson_Qian 2015-01-29 add
endif
ifeq ($(strip $(CENON_SOCKET_SUPPORT)),TRUE)
    COM_DEFS += __CENON_SOCKET_SUPPORT__			# Johnson_Qian 2015-01-29 add
endif
ifeq ($(strip $(CENON_SOCKET_DEMO_SUPPORT)),TRUE)
    COM_DEFS += __CENON_SOCKET_DEMO_SUPPORT__		# Johnson_Qian 2015-01-29 add
endif
ifeq ($(strip $(CENON_SOCKET_JD_SUPPORT)),TRUE)
    COM_DEFS += __CENON_SOCKET_JD_SUPPORT__			# Johnson_Qian 2015-02-03 add
endif
ifeq ($(strip $(CENON_SOCKET_JDBT_SUPPORT)),TRUE)
    COM_DEFS += __CENON_SOCKET_JDBT_SUPPORT__			# Johnson_Qian 2015-07-27 add
endif
ifeq ($(strip $(CENON_SOCKET_VOTO_SUPPORT)),TRUE)
    COM_DEFS += __CENON_SOCKET_VOTO_SUPPORT__		# Johnson_Qian 2015-02-03 add
endif
ifeq ($(strip $(CENON_SOCKET_CJ_SUPPORT)),TRUE)
    COM_DEFS += __CENON_SOCKET_CJ_SUPPORT__		# Johnson_Qian 2015-07-27 add
endif
ifeq ($(strip $(CENON_SOCKET_QIWO_SUPPORT)),TRUE)
    COM_DEFS += __CENON_SOCKET_QIWO_SUPPORT__
endif
ifeq ($(strip $(CENON_A615_YX_PROJECT)),TRUE)
    COM_DEFS += __CENON_A615_YX_PROJECT__
endif
ifeq ($(strip $(CENON_A615_YX_FM_TEST)),TRUE)
    COM_DEFS += __CENON_A615_YX_FM_TEST__
endif
ifeq ($(strip $(CENON_YX_FOREIGN_VERSION)),TRUE)
    COM_DEFS += __CENON_YX_FOREIGN_VERSION__
endif
ifeq ($(strip $(CENON_MMI_A611_PROJECT)),TRUE)
    COM_DEFS += __CENON_MMI_A611_PROJECT__
endif
ifeq ($(strip $(CENON_A611_VOTO_PROJECT)),TRUE)
    COM_DEFS += __CENON_A611_VOTO_PROJECT__
endif
ifeq ($(strip $(CENON_MMI_VOTO_FACTORY_MODE)),TRUE)
    COM_DEFS += __CENON_MMI_VOTO_FACTORY_MODE__
endif
ifeq ($(strip $(CENON_FONT_ENGINE_BITMAP_SUPPORT)),TRUE)
    COM_DEFS += __CENON_FONT_ENGINE_BITMAP_SUPPORT__
endif
ifeq ($(strip $(CENON_VOTO_WATCH_APP)),TRUE)
      COM_DEFS += __CENON_VOTO_WATCH_APP__
      COM_DEFS += __MMI_PHNSET_SCHEDULE_POWER_ON_OFF__
      COM_DEFS += __CENON_HIGH_BATTERY_SUPPORT__		#���������
      COM_DEFS += __CENON_VOTO_WATCH_APP_OLDLED__               # ����
      #COM_DEFS += __CENON_VOTO_WATCH_APP_NEWLED__           # 0.66 ���� 
      #COM_DEFS += __CENON_VOTO_WATCH_APP_W1B__		#W1B  �ܰ汾	voto �汾����
      #COM_DEFS += __CENON_ROCK_WATCH_APP_W1B__			#W1B ROCK�汾  ���𿪹ػ������Ͱ汾��
endif

ifeq ($(strip $(CENON_A611_YUNWA_APP)),TRUE)
      COM_DEFS += __CENON_YUNWA_APP__
endif

ifeq ($(strip $(CENON_BT40_FUNC_FEATURE)),TRUE)
    COM_DEFS += __CENON_BT40_FUNC_FEATURE__
    ifeq ($(strip $(CENON_MMI_BT40_ANTILOST_ALERT)),TRUE)
        COM_DEFS += __CENON_MMI_BT40_ANTILOST_ALERT__
    endif
endif
ifeq ($(strip $(CENON_COMMON_FEATURE)),TRUE)
    COM_DEFS += __CENON_COMMON_FEATURE__
endif
ifeq ($(strip $(CENON_BT40_MAIN_MODE)),TRUE)
    COM_DEFS += __CENON_BT40_MAIN_MODE__
endif
ifeq ($(strip $(CENON_CUST_IMAGE_PATH)),TRUE)
    COM_DEFS += __CENON_CUST_IMAGE_PATH__
endif
ifeq ($(strip $(CENON_BL_TIME_10SEC_FEATURE)),TRUE)
    COM_DEFS += __CENON_BL_TIME_10SEC_FEATURE__
endif
###############CENON MMI ���ƻ����� start###################
## Cenon MMI�ϳ���bug fix�޸ĺ�
ifeq ($(strip $(CENON_MMI_COMMON_BUG)),TRUE)
	COM_DEFS += __CENON_MMI_COMMON_BUG__
endif
## Cenon�Լ�ģ���ܿ���
ifeq ($(strip $(CENON_MMI_MODULE)),TRUE)
	COM_DEFS += __CENON_MMI_MODULE__
endif
## ������ʱ����
ifeq ($(strip $(CENON_MMI_SIMPLETTS_FEATRUE)),TRUE)
	COM_DEFS += __CENON_MMI_SIMPLETTS_FEATRUE__
endif
## ���ع����ṩ
ifeq ($(strip $(CENON_MMI_LOCALFUNC_FEATRUE)),TRUE)
	COM_DEFS += __CENON_MMI_LOCALFUNC_FEATRUE__
endif
## ��ƿͻ�����
ifeq ($(strip $(CENON_MMI_CJAPP_FEATRUE)),TRUE)
	COM_DEFS += __CENON_MMI_CJAPP_FEATRUE__
endif

ifeq ($(strip $(CENON_MMI_WATCH_CONTACTS)),TRUE)
	COM_DEFS += __CENON_MMI_WATCH_CONTACTS__
endif
###############CENON MMI ���ƻ����� end###################
ifeq ($(strip $(XI_SUPPORT)),TRUE)
	COM_DEFS += __XI_SUPPORT__
endif
