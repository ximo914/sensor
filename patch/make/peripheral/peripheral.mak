...
SRC_LIST = hal\peripheral\src\dcl_pfc.c \
       ...
       hal\peripheral\cenon\platform\cenon_platform.c\
       hal\peripheral\cenon\led\cenon_led.c\
       hal\peripheral\cenon\uart\cenon_uart.c\
       hal\peripheral\cenon\heart\cenon_heart.c\
       hal\peripheral\cenon\gps\cenon_ublox.c\
       hal\peripheral\cenon\bluetooth\dialog_full\bt40_dialog.c\
       hal\peripheral\cenon\factory\cenon_factory.c\
       hal\peripheral\cenon\socket\soc_platform.c \
       hal\peripheral\cenon\socket\soc_device_data.c \
       hal\peripheral\cenon\socket\soc_parser_cjson.c \
       hal\peripheral\cenon\socket\soc_parser_websocket.c \
       hal\peripheral\cenon\socket\soc_projects_pwron_init.c \
       hal\peripheral\cenon\uvsensor\si1133.c \
       hal\peripheral\cenon\gsensor\qma6981.c 
      
       
ifneq ($(filter __CENON_SOCKET_CJ_SUPPORT__, $(strip $(MODULE_DEFS))),)
SRC_LIST += hal\peripheral\cenon\socket\soc_cj_device.c \
            hal\peripheral\cenon\socket\soc_cj_data.c \
            hal\peripheral\cenon\socket\soc_cj_function.c \
            hal\peripheral\cenon\socket\soc_cj_protocol.c \
            hal\peripheral\cenon\socket\soc_cj_socket.c
endif
ifneq ($(filter __CENON_SOCKET_VOTO_SUPPORT__, $(strip $(MODULE_DEFS))),)
SRC_LIST += hal\peripheral\cenon\socket\soc_voto_device.c \
            hal\peripheral\cenon\socket\soc_voto_data.c \
            hal\peripheral\cenon\socket\soc_voto_function.c \
            hal\peripheral\cenon\socket\soc_voto_protocol.c \
            hal\peripheral\cenon\socket\soc_voto_socket.c
endif    
ifneq ($(filter __CENON_SOCKET_JD_SUPPORT__, $(strip $(MODULE_DEFS))),)
SRC_LIST += hal\peripheral\cenon\socket\soc_jd_device.c \
            hal\peripheral\cenon\socket\soc_jd_data.c \
            hal\peripheral\cenon\socket\soc_jd_function.c \
            hal\peripheral\cenon\socket\soc_jd_protocol.c \
            hal\peripheral\cenon\socket\soc_jd_socket.c
endif
ifneq ($(filter __CENON_SOCKET_QIWO_SUPPORT__, $(strip $(MODULE_DEFS))),)
SRC_LIST += hal\peripheral\cenon\socket\qiwo\soc_qiwo_device.c\
            hal\peripheral\cenon\socket\qiwo\soc_qiwo_data.c \
            hal\peripheral\cenon\socket\qiwo\soc_qiwo_function.c \
            hal\peripheral\cenon\socket\qiwo\soc_qiwo_protocol.c \
            hal\peripheral\cenon\socket\qiwo\cJSON.c \
            hal\peripheral\cenon\socket\qiwo\soc_qiwo_socket.c
endif

ifneq ($(filter __XI_SUPPORT__, $(strip $(MODULE_DEFS))),)
SRC_LIST += hal\peripheral\network\network.c\
            hal\peripheral\network\protocol.c \
            hal\peripheral\network\sampling.c \
            hal\peripheral\network\crc32.c \
            hal\peripheral\network\mem.c \
