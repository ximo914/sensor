...
{    
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_TYPE_FACTORY_CONF, /* type */ 
            CUSTOM_DTCNT_SIM_TYPE_1,      /* SIM1/SIM2 */
            (const kal_uint8*)L"Etisalat WAP", /* Account Name */
            "", /* Home page */
            {
                CUSTOM_DTCNT_PROF_GPRS_AUTH_TYPE_NORMAL,
                "", ""  /* username, password */
            ...
            CUSTOM_DTCNT_PROF_PX_SRV_HTTP,  /* proxy service type */
            8080, /* proxy port */
            "10.71.170.5", /* proxy address, domain name */
            "", "",  /* proxy username, password */
            "", "", "", "", "", "",
            DTCNT_APPTYPE_BRW_HTTP | DTCNT_APPTYPE_MRE_WAP | DTCNT_APPTYPE_TETHERING | DTCNT_APPTYPE_PLAYER | DTCNT_APPTYPE_DEF | DTCNT_APPTYPE_PUSH, /* app type */
            "62160" /* SIM ID */
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_TYPE_FACTORY_CONF, /* type */ 
            CUSTOM_DTCNT_SIM_TYPE_1,      /* SIM1/SIM2 */
            (const kal_uint8*)L"web.gprs.mtnnigeria.net", /* Account Name */
            "", /* Home page */
            {
                CUSTOM_DTCNT_PROF_GPRS_AUTH_TYPE_NORMAL,
                "", ""  /* username, password */
            ...
            CUSTOM_DTCNT_PROF_PX_SRV_HTTP,  /* proxy service type */
            8080, /* proxy port */
            "10.199.212.2", /* proxy address, domain name */
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_TYPE_FACTORY_CONF, /* type */ 
            CUSTOM_DTCNT_SIM_TYPE_1,      /* SIM1/SIM2 */
            (const kal_uint8*)L"glodirect", /* Account Name */
            "", /* Home page */
            {
                CUSTOM_DTCNT_PROF_GPRS_AUTH_TYPE_NORMAL,
                "", ""  /* username, password */
            ...
            8080, /* proxy port */
            "", /* proxy address, domain name */
            "secure", "secure",  /* proxy username, password */
            "", "", "", "", "", "",
            DTCNT_APPTYPE_BRW_HTTP | DTCNT_APPTYPE_MRE_WAP | DTCNT_APPTYPE_TETHERING | DTCNT_APPTYPE_PLAYER | DTCNT_APPTYPE_DEF | DTCNT_APPTYPE_PUSH, /* app type */
            "62150" /* SIM ID */
        },

        (const kal_uint8*)"glodirect"
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_TYPE_FACTORY_CONF, /* type */ 
            CUSTOM_DTCNT_SIM_TYPE_1,      /* SIM1/SIM2 */
            (const kal_uint8*)L"Zain", /* Account Name */
            "", /* Home page */
            {
                CUSTOM_DTCNT_PROF_GPRS_AUTH_TYPE_NORMAL,
                "", ""  /* username, password */
            ...
            CUSTOM_DTCNT_PROF_PX_SRV_HTTP,  /* proxy service type */
            8080, /* proxy port */
            "172.18.254.5", /* proxy address, domain name */
            "internet", "internet",  /* proxy username, password */
            "", "", "", "", "", "",
            DTCNT_APPTYPE_BRW_HTTP | DTCNT_APPTYPE_MRE_WAP | DTCNT_APPTYPE_TETHERING | DTCNT_APPTYPE_PLAYER | DTCNT_APPTYPE_DEF | DTCNT_APPTYPE_PUSH, /* app type */
            "62120" /* SIM ID */
        },

        (const kal_uint8*)"internet.ng.zain.com"
     ...
     {
        {
            ...
            CUSTOM_DTCNT_PROF_PX_SRV_HTTP,  /* proxy service type */
            80, /* proxy port */
            "202.75.133.49", /* proxy address, domain name */
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_PX_SRV_HTTP,  /* proxy service type */
            80, /* proxy port */
            "203.92.128.160", /* proxy address, domain name */
            "", "",  /* proxy username, password */
            "", "", "", "", "", "",
            DTCNT_APPTYPE_BRW_HTTP | DTCNT_APPTYPE_MRE_WAP | DTCNT_APPTYPE_TETHERING | DTCNT_APPTYPE_PLAYER | DTCNT_APPTYPE_DEF | DTCNT_APPTYPE_PUSH, /* app type */
            "50216, 50210" /* SIM ID */
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_PX_SRV_HTTP,  /* proxy service type */
            8080, /* proxy port */
            "10.128.1.242", /* proxy address, domain name */
            "", "",  /* proxy username, password */
            "", "", "", "", "", "",
            DTCNT_APPTYPE_BRW_HTTP | DTCNT_APPTYPE_MRE_WAP | DTCNT_APPTYPE_TETHERING | DTCNT_APPTYPE_PLAYER | DTCNT_APPTYPE_DEF | DTCNT_APPTYPE_PUSH, /* app type */
            "50213, 50219" /* SIM ID */
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_TYPE_FACTORY_CONF, /* type */ 
            CUSTOM_DTCNT_SIM_TYPE_1,      /* SIM1/SIM2 */
            (const kal_uint8*)L"EAE", /* Account Name */
            "", /* Home page */
            {
                CUSTOM_DTCNT_PROF_GPRS_AUTH_TYPE_NORMAL,
                "", ""  /* username, password */
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_TYPE_FACTORY_CONF, /* type */ 
            CUSTOM_DTCNT_SIM_TYPE_1,      /* SIM1/SIM2 */
            (const kal_uint8*)L"Mobily", /* Account Name */
            "", /* Home page */
            {
                CUSTOM_DTCNT_PROF_GPRS_AUTH_TYPE_NORMAL,
                "", ""  /* username, password */
    ...
    },
    {
        ...
        (const kal_uint8*)"jawalnet.com.sa"
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_PX_SRV_HTTP,  /* proxy service type */
            8080, /* proxy port */
            "203.170.229.34", /* proxy address, domain name */
            "", "",  /* proxy username, password */
            "", "", "", "", "", "",
            DTCNT_APPTYPE_BRW_HTTP | DTCNT_APPTYPE_MRE_WAP | DTCNT_APPTYPE_TETHERING | DTCNT_APPTYPE_PLAYER | DTCNT_APPTYPE_DEF | DTCNT_APPTYPE_PUSH, /* app type */
            "52001" /* SIM ID */
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_PX_SRV_HTTP,  /* proxy service type */
            8080, /* proxy port */
            "203.155.200.133", /* proxy address, domain name */
            "", "",  /* proxy username, password */
            "", "", "", "", "", "",
            DTCNT_APPTYPE_BRW_HTTP | DTCNT_APPTYPE_MRE_WAP | DTCNT_APPTYPE_TETHERING | DTCNT_APPTYPE_PLAYER | DTCNT_APPTYPE_DEF | DTCNT_APPTYPE_PUSH, /* app type */
            "52018" /* SIM ID */
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_TYPE_FACTORY_CONF, /* type */ 
            CUSTOM_DTCNT_SIM_TYPE_1,      /* SIM1/SIM2 */
            (const kal_uint8*)L"True Move", /* Account Name */
            "http://mms.trueworld.net:8002/", /* Home page */
            {
                CUSTOM_DTCNT_PROF_GPRS_AUTH_TYPE_NORMAL,
                "", ""  /* username, password */
            },
            ...
            CUSTOM_DTCNT_PROF_PX_SRV_HTTP,  /* proxy service type */
            8080, /* proxy port */
            "10.4.7.39", /* proxy address, domain name */
            "true", "true",  /* proxy username, password */
            "", "", "", "", "", "",
            DTCNT_APPTYPE_BRW_HTTP | DTCNT_APPTYPE_MRE_WAP | DTCNT_APPTYPE_TETHERING | DTCNT_APPTYPE_PLAYER | DTCNT_APPTYPE_DEF | DTCNT_APPTYPE_PUSH, /* app type */
            "52099" /* SIM ID */
        },

        (const kal_uint8*)"True Move"
    ...
    {
        {
            ...
            CUSTOM_DTCNT_PROF_TYPE_FACTORY_CONF, /* type */ 
            CUSTOM_DTCNT_SIM_TYPE_1,      /* SIM1/SIM2 */
            (const kal_uint8*)L"Zain SA", /* Account Name */
            "", /* Home page */
            {
                CUSTOM_DTCNT_PROF_GPRS_AUTH_TYPE_NORMAL,
                "", ""  /* username, password */
        ...
        (const kal_uint8*)"Zain SA"
#endif // __CENON_YX_FOREIGN_VERSION__
    }
};
#endif
